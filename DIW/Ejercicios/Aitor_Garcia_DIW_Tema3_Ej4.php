...
<head>
    ...
    <link rel="stylesheet" href="ricks.css">
</head>
<body>
<div class="container">

    <div class="card details">
        <h3><strong>Buscar personaje</strong></h3>
        <form>
            <label for="name">ID:</label>
            <input type="text" id="name" name="name" placeholder="Buscar por id" >
            <br>
            <button type="submit" class="formulario">Buscar</button>
        </form>
